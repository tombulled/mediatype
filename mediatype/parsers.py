...
class Parser:
    ...
    @classmethod
    def parse(cls, mime_type: str) -> typing.Dict[str, typing.Any]:
        type:      str
        subtype:   str
        ...
        type    = enums.MediaTypeType(type)       if type    in enums.MediaTypeType.__members__.values()    else type
        subtype = enums.MediaTypeSubtype(subtype) if subtype in enums.MediaTypeSubtype.__members__.values() else subtype
        suffix  = enums.MediaTypeSuffix(suffix)   if suffix  in enums.MediaTypeSuffix.__members__.values()  else suffix
